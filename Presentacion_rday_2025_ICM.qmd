...
<div class="arrow-flow">
  <div class="arrow">Observaciones intercambiables</div>
  <div class="arrow">Medida de no conformidad</div>
  <div class="arrow">P-valores</div>
  <div class="arrow">Función de apuesta</div>
  <div class="arrow">Martingala</div>
  <div class="arrow">Alarma</div>
</div>
...
Todos los experimentos descritos en esta sección aprovechan las características de los paquetes `future`, `purrr`, `tidyr`, `dplyr` y `ggplot2`.
<br/>
