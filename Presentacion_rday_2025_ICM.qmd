---
title: "Martingalas inductivas conformales: una implementación en R."
subtitle: "R Day 2025"
author: "Cristhian Quiroz Castaño - Universidad EAFIT"
date: today
lang: es
format:
  revealjs:
...
::: {.center .small}
*Intuitivamente, entre más pequeño es el* $p$-valor, más extraña es la observación.
:::
...
::: center
![Librerias R](images/libreriashexalogor.png){width="55%"}
:::

## Planteamiento de los Monte Carlo
...
::: center
![Sensibilidad al umbral](images/FA_vs_MD_mixt.png){width="70%"}
:::

## Sensibilidad al umbral

::: center
![Tabla](images/Tabla_2_mixturebf.png){width="70%"}
:::

<br/>

Se hace más evidente en esta tabla cómo los métodos propuestos `MAD` y `IQR` presentan una leve reducción en el retardo medio

## Sensibilidad KNN

::: center
![Sensibilidad al K](images/KNNSENS.png){width="70%"}
:::

## Precisión de los métodos múltiples

::: center
![Precision multiples detectores](images/MULTIPRES.png){width="70%"}
:::
